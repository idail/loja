...
<div class="modal fade" id="visualiza-imagens-produtos" tabindex="-1" data-bs-backdrop="false">
            ...
            <div class="modal-body">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-4 pb-2">
                            <h5 class="card-title text-center pb-0 fs-4">Visualização Imagens</h5>
                        </div>
                        ...
                        <form class="row g-3" id="" novalidate>
                            ...
                            <div class="col-lg-12" style="display: block;">
                                ...
                                <div id="exibi-imagens-produtos-cadastrados"></div>
                            ...
                            <div class="col-12">
                                <button id="alterar-cliente" class="btn btn-primary w-100" type="button">Alterar Cliente</button>
                            </div> -->
                            <!-- <div class="col-12">
                            ...
                            <!-- <div class="col-12">
                                <div class="alert alert-success bg-success text-light border-0 alert-dismissible fade show" id="recebe-mensagem-alterar-realizado-cliente" role="alert">
