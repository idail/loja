        ...
        <div class="row mb-4 col-lg-12">
            ...
            <div class="col-sm-2">
                <select class="form-select" aria-label="Default select example" id="filtro-produto">
                    ...
                    <option value="categoria_produto">Produto</option>
                    <option value="nome_produto">Cliente</option>
                    <option value="todos_produto">Desconto</option>
                    <option value="todos_produto">Pago</option>
                    <option value="todos_produto">Data</option>
                </select>
            </div>
